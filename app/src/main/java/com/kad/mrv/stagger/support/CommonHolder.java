...
public class CommonHolder extends RecyclerView.ViewHolder {
    ...
    public CommonHolder(Context context, View itemView, ViewGroup parent, int position) {
        super(itemView);
        mContext = context;
    ...
    public static CommonHolder get(Context context, View convertView,
        ...
        if (convertView == null) {
            ...
            CommonHolder holder = new CommonHolder(context, itemView, parent, position);
    ...
    public CommonHolder setImageUrl(int viewId, String imageUrlString) {
//        SimpleDraweeView view = (SimpleDraweeView) getView(viewId);
//        view.setImageURI(UriUtil.parseUriOrNull(imageUrlString));
        return this;
    }
